...
func (r *Account) Burn(amountStr string, fromMember insolar.Reference, request insolar.Reference) error {
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, false, false, "Burn", argsSerialized, *PrototypeReference)
	if err != nil {
		return err
	}
...
func (r *Account) BurnAsImmutable(amountStr string, fromMember insolar.Reference, request insolar.Reference) error {
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, true, false, "Burn", argsSerialized, *PrototypeReference)
	if err != nil {
		return err
	}
