...
var PrototypeReference, _ = insolar.NewObjectReferenceFromString("insolar:0AAABAvAGTBa9HaFtJEOYWD3KWeXJM8NSGx5-uok-VGM")
...
// ShowHelloWorldMessage is proxy generated method
func (r *HelloWorld) ShowHelloWorldMessage() (string, error) {
	var args [0]interface{}
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, false, false, "ShowHelloWorldMessage", argsSerialized, *PrototypeReference)
	if err != nil {
		return ret0, err
	}
...
// ShowHelloWorldMessageAsImmutable is proxy generated method
func (r *HelloWorld) ShowHelloWorldMessageAsImmutable() (string, error) {
	var args [0]interface{}
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, true, false, "ShowHelloWorldMessage", argsSerialized, *PrototypeReference)
	if err != nil {
		return ret0, err
	}
