...
func INSMETHOD_CreateBurnedAccount(object []byte, data []byte) (newState []byte, result []byte, err error) {
	...
	if len(object) == 0 {
		err = &foundation.Error{S: "[ FakeCreateBurnedAccount ] ( INSMETHOD_* ) ( Generated Method ) Object is nil"}
		return
	}

	err = ph.Deserialize(object, self)
	if err != nil {
		err = &foundation.Error{S: "[ FakeCreateBurnedAccount ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Data: " + err.Error()}
		return
	}
	...
	err = ph.Deserialize(data, &args)
	if err != nil {
		err = &foundation.Error{S: "[ FakeCreateBurnedAccount ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return
	}
	...
	ret0, ret1 = self.CreateBurnedAccount()
...
func Initialize() insolar.ContractWrapper {
	return insolar.ContractWrapper{
		Methods: insolar.ContractMethods{
			...
			"CreateBurnedAccount": INSMETHOD_CreateBurnedAccount,
