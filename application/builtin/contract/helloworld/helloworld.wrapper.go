...
func INSMETHOD_ShowHelloWorldMessage(object []byte, data []byte) (newState []byte, result []byte, err error) {
	ph := common.CurrentProxyCtx
	...
	if len(object) == 0 {
		err = &foundation.Error{S: "[ FakeShowHelloWorldMessage ] ( INSMETHOD_* ) ( Generated Method ) Object is nil"}
		return
	}

	err = ph.Deserialize(object, self)
	if err != nil {
		err = &foundation.Error{S: "[ FakeShowHelloWorldMessage ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Data: " + err.Error()}
		return
	}
	...
	if err != nil {
		err = &foundation.Error{S: "[ FakeShowHelloWorldMessage ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return
	}
	...
	ret0, ret1 = self.ShowHelloWorldMessage()
...
func Initialize() insolar.ContractWrapper {
	return insolar.ContractWrapper{
		Methods: insolar.ContractMethods{
			"ShowHelloWorldMessage": INSMETHOD_ShowHelloWorldMessage,
